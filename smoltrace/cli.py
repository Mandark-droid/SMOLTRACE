...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run agent evaluations with enhanced dataset management")
    
    # Core arguments
    parser.add_argument("--model", type=str, required=True, help="Model ID")
    parser.add_argument("--hf-token", type=str, help="HuggingFace token (can also be set with HF_TOKEN env var)")
    
    # Agent configuration
    parser.add_argument("--agent-type", type=str, choices=['tool', 'code', 'both'], default='both', help="Type of agent to evaluate")
    ...
    # Test configuration
    parser.add_argument("--difficulty", type=str, choices=['easy', 'medium', 'hard'], help="Filter tests by difficulty")
    parser.add_argument("--dataset-name", type=str, default="kshitijthakkar/smoalagent-tasks", help="HF dataset for tasks")
