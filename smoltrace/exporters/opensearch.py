...
LEADERBOARD_INDEX_MAPPING = {
    "mappings": {
        "properties": {
            ...
            "pass_at_1": {"type": "float"},
            "pass_rule": {"type": "keyword"},
            "pass_attempts": {"type": "integer"},
            "evaluated_prompts": {"type": "integer"},
            "passed_prompts": {"type": "integer"},
